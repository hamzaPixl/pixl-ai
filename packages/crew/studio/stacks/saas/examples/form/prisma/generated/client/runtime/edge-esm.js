...
var Ei = Le((Ye) => {
  ...
  T.prototype.readInt8 = function (e, t) {
    return (
      (e = e >>> 0), t || H(e, 1, this.length), this[e] & 128 ? (255 - this[e] + 1) * -1 : this[e]
    );
  };
...
var $i,
  ...
  Vi = Ae(() => {
    ...
    d();
    m();
    ($i = '/'), (Ka = { sep: $i }), (za = { resolve: Ha, posix: Ka, join: Wa, sep: $i }), (Tt = za);
  });
var fr,
  Ji = Ae(() => {
    'use strict';
...
C.toNearest = function (e, t) {
  ...
  return (
    e.d[0] ? ((_ = !1), (r = U(r, e, 0, t, 1).times(e)), (_ = !0), O(r)) : ((e.s = r.s), (r = e)), r
  );
};
C.toNumber = function () {
  return +this;
...
function ot(e) {
  let t = e.showColors ? Xl : eu,
    r;
  return (
    typeof $getTemplateParameters < 'u' ? (r = $getTemplateParameters(e, t)) : (r = tu(e)), ru(r, t)
  );
}
f();
c();
