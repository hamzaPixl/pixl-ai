...
var mi = ge((tt) => {
  ...
  T.prototype.readInt8 = function (e, t) {
    return (
      (e = e >>> 0), t || G(e, 1, this.length), this[e] & 128 ? (255 - this[e] + 1) * -1 : this[e]
    );
  };
...
var Ri,
  ...
  an = Le(() => {
    ...
    d();
    f();
    (Ri = '/'), (dl = { sep: Ri }), (fl = { resolve: cl, posix: dl, join: pl, sep: Ri }), (we = fl);
  });
var ki = ge((nf, Oi) => {
  'use strict';
  m();
...
R.inverseTangent = R.atan = function () {
  ...
  return r && (s = s.times(2 << (r - 1))), (L = !0), k(s, (g.precision = h), (g.rounding = P), !0);
};
R.isFinite = function () {
  return !!this.d;
};
...
R.toNearest = function (e, t) {
  ...
  return (
    e.d[0] ? ((L = !1), (r = j(r, e, 0, t, 1).times(e)), (L = !0), k(r)) : ((e.s = r.s), (r = e)), r
  );
};
R.toNumber = function () {
  return +this;
...
function k(e, t, r, n) {
  ...
  return (
    L && (e.e > S.maxE ? ((e.d = null), (e.e = NaN)) : e.e < S.minE && ((e.e = 0), (e.d = [0]))), e
  );
}
function be(e, t, r) {
...
function ho(e, t, r) {
  let n = [`Unknown argument \`${e.red(t)}\`.`],
    i = Zu(t, r);
  return i && n.push(`Did you mean \`${e.green(i)}\`?`), r.length > 0 && n.push(Bt(e)), n.join(' ');
}
function Uu(e, t) {
  let r;
  t.addErrorMessage((l) =>
