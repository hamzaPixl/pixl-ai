...
description: "Best practices for Stripe integrations: checkout flows, subscriptions, webhooks, and Connect platforms. Use when implementing payment processing or any Stripe API integration."
allowed-tools: Read, Glob, Grep, Bash
argument-hint: "<integration type: checkout, subscriptions, webhooks, connect>"
---
