...
Read `references/video-vocabulary.md` for scene type, animation, and atmosphere vocabulary.
...
Read `references/video-brief-schema.md` for the full video-brief.json schema template.
